...
function AddPerson(props) {
    ...
    return (
    <>
            <Modal title={<span><UserAddOutlined style={{fontSize:'35px', color:'blue',marginRight:'2rem'}} />   Добавить жильца</span> } visible={isModalVisible} onOk={handleCancel}  onCancel={handleCancel}
                   okText='Tushunarli'
                   okType='confirm'
                   cancelText='Yopish'
                   footer={[
                       ...
                       <Button key="submit" type="primary" onClick={()=>addPersons()}>
                           Добавить
                       </Button>
                       </>
